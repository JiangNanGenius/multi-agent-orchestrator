...
**⚠️ 重要强制要求：必须指定 `agentId="review_center"`，否则子agent会继承 plan_center 的身份！**

```python
# ✅ 正确示例
# sessions_spawn task="<评审任务单内容>" runtime="subagent" agentId="review_center" mode="run" label="review_<task_id>"
...
**⚠️ 重要强制要求：必须指定 `agentId="dispatch_center"`，否则子agent会继承 plan_center 的身份！**

```python
# ✅ 正确示例
# sessions_spawn task="<调度任务单内容>" runtime="subagent" agentId="dispatch_center" mode="run" label="dispatch_<task_id>"
