...
> **任务**：审查一段 FastAPI 代码的安全性，输出问题清单和修复建议
...
| # | 子任务 | 执行角色 | 说明 |
|---|--------|----------|------|
| 1 | 代码安全扫描 | 代码专家 | 逐文件审查，标记安全问题 |
| 2 | 合规与最佳实践检查 | 审计专家 | 对照 OWASP Top 10 检查合规性 |
| 3 | 修复方案输出 | 代码专家 | 针对每个问题给出修复代码 |
...
**评审意见：** *"方案合理。代码专家负责工程侧审查，审计专家负责合规侧审查，分工明确。注意审计专家需出具 OWASP 逐项对照表，不能只写‘基本合规’。同意执行。"*
...
**审计专家结论：** 6/10 项需要处理，其中 2 项不合规（A02、A03），需立即修复。
...
评审中心首轮即通过，代码专家与审计专家分工明确：代码专家负责代码层面扫描和修复，审计专家负责合规框架对照。
