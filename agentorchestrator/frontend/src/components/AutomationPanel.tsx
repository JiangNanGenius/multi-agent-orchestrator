...
import { useStore, isAgentOrchestrator, isArchived, getTaskScheduler, getSchedulerSummary, stateLabel } from '../store';
...
export default function AutomationPanel() {
  ...
  const tasks = (liveStatus?.tasks || []).filter((t) => isAgentOrchestrator(t) && !isArchived(t));
