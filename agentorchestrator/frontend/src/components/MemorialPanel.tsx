...
import { useStore, isAgentOrchestrator, normalizeDeptLabel, normalizeFlowRemark, stateLabel, deptMeta, normalizeAgentId } from '../store';
...
export default function ArchivePanel() {
  ...
  let archivedTasks = tasks.filter((t) => isAgentOrchestrator(t) && ['Done', 'Cancelled'].includes(t.state));
