...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("state", sa.String(20), nullable=False, server_default="ControlCenter"),
        sa.Column("assignee_org", sa.String(50), nullable=True),
        sa.Column("creator", sa.String(50), server_default="system"),
        sa.Column("tags", postgresql.JSONB(), server_default="[]"),
        sa.Column("org", sa.String(32), nullable=False, server_default="总控中心"),
        sa.Column("owner", sa.String(32), server_default=""),
