...
遵循 AgentOrchestrator Architecture §3 事件结构规范。
"""
...
class Event(Base):
    ...
    # 事件数据
    payload = Column(JSON, default=dict, comment="事件负载")
    meta = Column(JSON, default=dict, comment="元数据 {priority, model, version}")
