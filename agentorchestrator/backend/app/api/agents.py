...
AGENT_META = {
    ...
    "audit_specialist": {"name": "审计专家", "role": "质量审查、测试校验与合规把关", "icon": "⚖️"},
    "deploy_specialist": {"name": "部署专家", "role": "工程交付、自动化与部署实施", "icon": "🧰"},
    "admin_specialist": {"name": "管理专家", "role": "技能管理、配置维护与运营支持", "icon": "🗂️"},
    "expert_curator": {"name": "专家编组官", "role": "专家新增、下线与名册治理一致性维护", "icon": "🧩"},
